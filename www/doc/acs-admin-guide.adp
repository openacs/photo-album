...
<li><p class="listitem">
<i class="emphasis">Imagemagick</i> The convert
and identify binaries must be installed within the location
...
<i class="emphasis">Image Storage Directory</i>
The photo album store image binaries in the file system. The
webserver user must have read, write, and execute privileges for
the directory specified in the parameter PhotoDir. This directory
must be in the acs root directory for the server. The webserver
user must also have write privilege on any file created in this
directory or it will not be able to delete images.</p></li><li><p class="listitem">
<i class="emphasis">Permission Checks for
Serving Images</i> The parameter CheckPermissionOnImageServeP
...
Album 4.0.1 Final Release</td><td width="34%" align="center" valign="top"> </td><td width="33%" align="right" valign="top">Developer's guide</td>
</tr>
</table>
</div>
