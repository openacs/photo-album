...
# or
#  <include src="/packages/photo-album/www/random-photo" photo_id="9912"> where 9912
#    is the photo_id of a photo in one of your albums.
# or
#  <include src="/packages/photo-album/www/random-photo" album_id="2983"> where 2983
...
# If neither package_id, album_id nor url is defined, the random photo is taken from all photos
# in the system.
